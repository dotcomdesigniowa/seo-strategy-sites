  ...
  additional_opportunities: [
    {
      ...
      description: "Upgrading to Level A doubles the plan to 20 combinations, allowing MEK Interiors & Floors to introduce a second city alongside Houston. Pearland, Cypress, or Sugar Land are the top candidates, each with strong residential construction and flooring demand.",
      keywords: [
        { keyword: "carpet installation",            monthly_searches: 27100 },
        { keyword: "hardwood floor installation",    monthly_searches:  9900 },
        { keyword: "flooring contractor",            monthly_searches:  8100 },
    ...
    },
    {
      ...
      description: "Level B adds 20 more combinations, enabling MEK Interiors & Floors to cover additional service keywords across Houston and expand into two more suburban markets. This level introduces dedicated coverage for flooring installation, vinyl plank, and hardwood refinishing.",
      keywords: [
        { keyword: "flooring installation",          monthly_searches: 18100 },
        { keyword: "vinyl flooring installation",    monthly_searches:  4400 },
        { keyword: "hardwood flooring installation", monthly_searches:  5400 },
    ...
    },
    {
      ...
      description: "Level C provides the coverage needed to dominate the Greater Houston flooring market. With 40 total combinations, MEK Interiors & Floors can target 4 to 5 cities with a full suite of residential and commercial keywords, achieving comprehensive visibility across the region for every core service offered.",
      keywords: [
        { keyword: "commercial flooring installation",monthly_searches:  720 },
        { keyword: "commercial carpet installation", monthly_searches:  390 },
        { keyword: "flooring services",              monthly_searches: 6600 },
        { keyword: "The Woodlands or Conroe", new_market: true },
        { keyword: "Pasadena or Baytown", new_market: true },
      ]
    }
  ]
};
